...
<?php endif ?>
		  ...
		  <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="Login.html" class="nav-link">Home</a></li>
                  <li><a href="EmployeeGroup.html" class="nav-link">Employee Group</a></li>
                  <li><a href="CustomerGroup.html" class="nav-link">Customer Group</a></li>
