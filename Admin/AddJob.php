...
<link rel="stylesheet" href="https://formden.com/static/cdn/bootstrap-iso.css" />
 ...
 <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/css/bootstrap.css">
        ...
        <div class="container">
		  ...
		  <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="Jobs.php" class="nav-link">Back</a></li>
                   </ul>
              </nav>
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-color:#2F41C2">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">	 
		  <form name="form_login" method="post" action="AddJob.php" role="form">
  ...
  <div class="col-md-4 form-group">
		  ...
		  <div class="col-md-4 form-group">
                <select name="cmail" id="cmail" class="form-control w-100">
		<option disabled selected>select customer</option>
		<?php 
		require_once "config.php";
		$records = mysqli_query($link,"select email from users");
