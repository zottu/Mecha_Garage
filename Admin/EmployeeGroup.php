      ...
      <div class="realestate-filter">
        <div class="container">
          ...
          <div class="realestate-filter-wrap nav">
            ...
            <div  ><div class="form-group"><br ><label  style = "text-align:left;font-size:40px;">EMPLOYEE GROUP</label>
		<button type="submit" class="btn btn-primary btn-lg" name="save">DELETE</button>
              	<input type="button" class="btn btn-primary btn-lg" onClick="pageRedirect()" value="ADD">		
		</div><br>
...
if(isset($_POST['save'])){
	...
	$del_id = $checkbox[$i]; 
	mysqli_query($link,"DELETE FROM employee WHERE employeeid='".$del_id."'");?>
...
?>
<tr>
    <td><input type="checkbox" id="checkItem" name="check[]" value="<?php echo $row["employeeid"]; ?>"></td>
	<td><?php echo $row["employeeid"]; ?></td>
	<td><?php echo $row["fname"]; ?></td>
	<td><?php echo $row["lname"]; ?></td>
	<td><?php echo $row["mobile"]; ?></td>
	<td><?php echo $row["email"]; ?><?php $_SESSION['eid']=$row["email"];?></td>
	<td><?php echo $row["password"]; ?></td>
	<td> <a href = "EmployeePass.php" title="">edit</a></td>		
